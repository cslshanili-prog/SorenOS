...
| 4 | 聊天設置改全螢幕 | 進行中（第一批：頁面＋Relationship，#24；第二批：已讀不回，#25；第三批：延遲自動回覆，#26；雲端延遲回覆，#27；第四批：線下邀請＋動作描寫，#29；第五批：角色主動打電話，#30；最後一批雙向拉黑＋臨時會話：設計見 [`plans/block-temp-chat-design.md`](./block-temp-chat-design.md)，拉黑本身 PR 待開，臨時會話待做） |
