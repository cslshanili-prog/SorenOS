...
export const SHOP_RECIPES: ShopRecipe[] = [
    { id: 'recipe-coffee-001', name: '手衝咖啡', icon: 'https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/72x72/2615.png', cost: 0, appeal: 10, isUnlocked: true },
    ...
    { id: 'recipe-tea-001', name: '伯爵紅茶', icon: 'https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/72x72/1f375.png', cost: 80, appeal: 25, isUnlocked: false },
    ...
    { id: 'recipe-cocktail-001', name: '特調氣泡水', icon: 'https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/72x72/1f379.png', cost: 500, appeal: 80, isUnlocked: false },
];

export const AVAILABLE_STAFF: Omit<ShopStaff, 'hireDate' | 'fatigue'>[] = [
    { id: 'staff-dog-01', name: '柴犬服務生', avatar: 'https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/72x72/1f436.png', role: 'waiter', maxFatigue: 120 },
    { id: 'staff-bear-01', name: '棕熊大廚', avatar: 'https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/72x72/1f43b.png', role: 'chef', maxFatigue: 150 },
    ...
    { id: 'staff-penguin-01', name: '企鵝採購', avatar: 'https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/72x72/1f427.png', role: 'manager', maxFatigue: 110 },
];
...
export const WALLPAPER_PRESETS = [
    ...
    { id: 'wp-mint', name: '薄荷綠', style: 'linear-gradient(180deg, #F0FFF4, #C6F6D5)' },
    { id: 'wp-sky', name: '天空藍', style: 'linear-gradient(180deg, #EBF8FF, #BEE3F8)' },
    { id: 'wp-lavender', name: '薰衣草', style: 'linear-gradient(180deg, #FAF5FF, #E9D8FD)' },
    { id: 'wp-warm', name: '暖陽橘', style: 'linear-gradient(180deg, #FFFAF0, #FEEBC8)' },
    { id: 'wp-brick', name: '復古磚牆', style: 'repeating-linear-gradient(0deg, #D4A574 0px, #D4A574 8px, #C4956A 8px, #C4956A 10px, #DEB587 10px, #DEB587 18px, #C4956A 18px, #C4956A 20px)' },
    { id: 'wp-stripe', name: '條紋', style: 'repeating-linear-gradient(90deg, #FFF8E1 0px, #FFF8E1 12px, #FFE0B2 12px, #FFE0B2 14px)' },
];

export const FLOOR_PRESETS = [
    { id: 'fl-wood', name: '木地板', style: 'linear-gradient(135deg, #C4A77D, #B8956E)' },
    { id: 'fl-tile', name: '白瓷磚', style: 'conic-gradient(from 90deg at 2px 2px, #fdf6e3 90deg, #eee8d5 0) 0 0/20px 20px' },
    { id: 'fl-check', name: '棋盤格', style: 'conic-gradient(#eee8d5 90deg, #fdf6e3 90deg 180deg, #eee8d5 180deg 270deg, #fdf6e3 270deg) 0 0 / 20px 20px' },
    { id: 'fl-dark', name: '深木紋', style: 'linear-gradient(135deg, #8B7355, #6D5A3F)' },
...
export const STICKER_LIBRARY = [
    ...
    { id: 'stk-clock', name: '掛鐘', url: 'https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/72x72/1f550.png', category: 'wall' },
    { id: 'stk-lamp', name: '檯燈', url: 'https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/72x72/1fa94.png', category: 'decor' },
    { id: 'stk-sofa', name: '沙發', url: 'https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/72x72/1f6cb.png', category: 'furniture' },
    { id: 'stk-table', name: '桌子', url: 'https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/72x72/1fa91.png', category: 'furniture' },
    { id: 'stk-book', name: '書架', url: 'https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/72x72/1f4da.png', category: 'furniture' },
    ...
    { id: 'stk-candle', name: '蠟燭', url: 'https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/72x72/1f56f.png', category: 'decor' },
    { id: 'stk-rug', name: '地毯', url: 'https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/72x72/1f9f6.png', category: 'floor' },
    { id: 'stk-cat', name: '貓咪', url: 'https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/72x72/1f431.png', category: 'pet' },
    { id: 'stk-star', name: '星星', url: 'https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/72x72/2b50.png', category: 'decor' },
    { id: 'stk-heart', name: '愛心', url: 'https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/72x72/2764.png', category: 'decor' },
    { id: 'stk-window', name: '窗戶', url: 'https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/72x72/1fa9f.png', category: 'wall' },
