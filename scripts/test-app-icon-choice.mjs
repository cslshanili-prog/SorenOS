...
try{
    ...
    await page.getByRole('button',{name:'水母 · 已選',exact:true}).waitFor();
    await checkName();
    await page.screenshot({path:out+'/choices.png'});
    await page.getByRole('button',{name:'經典',exact:true}).click();
    await page.getByRole('button',{name:'經典 · 已選',exact:true}).waitFor();
    ...
    await page.reload();await page.getByRole('button',{name:'經典 · 已選',exact:true}).waitFor();
    ...
    await page.getByText('已設置自定義圖標',{exact:true}).waitFor();
    ...
    await page.reload();await page.getByRole('button',{name:'水母 · 已選',exact:true}).waitFor();
