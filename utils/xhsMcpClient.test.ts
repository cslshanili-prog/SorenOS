...
describe('XHS Lite response normalization', () => {
    it('parses compact counters without turning 1.2萬 into 1', () => {
        expect(parseXhsCount('1.2萬')).toBe(12_000);
        expect(parseXhsCount('3萬+')).toBe(30_000);
